...
public class FollowFriendsServlet extends HttpServlet {
...
//		String friendsid = "5";
		...
		if(userService.followFriends(userid, friendsid)){
			out.println("成功");
			out.flush();
			System.out.println("成功关注该好友");
		}else {
			out.println();
			out.flush();
			System.out.println("关注该好友失败");
		}
